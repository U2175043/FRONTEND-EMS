...
function EmployeeSidebar({ userData, children }) {
          ...
          <div className="space-y-3">
              ...
              {userData && (
                <div>
                  <h1 className="text-xl font-bold">
                    Hi! {userData.emp.FirstName}
                  </h1>
                  <h2>
                    {" "}
                    Welcome to{" "}
                    {(userData.emp.Account === 1 && <strong>Admin</strong>) ||
                      (userData.emp.Account === 2 && <strong>HR</strong>) ||
                      (userData.emp.Account === 3 && (
            ...
            <div className="flex-1">
              <ul className="pt-2 pb-4 space-y-1 text-sm">
                ...
                <li className="rounded-sm">
                  <Link
                    to="/dashboard/employee/work-history/update"
                    className="flex items-center p-2 space-x-3 rounded-md"
                  >
                    <svg
                      className="w-6 h-6"
